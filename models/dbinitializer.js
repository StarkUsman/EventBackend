...
bookings.forEach(booking => {
  ...
  db.run(
    `INSERT INTO ledger (name, purch_id, vendor_id, amountDebit, amountCredit, balance, createdAt) VALUES 
      ('SRV', 101, 15, 5000.00, 0.00, 6789.00, '2023-12-01 10:00:00'),
      ('CPV', 102, 15, 0.00, 2000.00, 4789.00, '2023-12-05 14:30:00'),
      ('BPV', 103, 15, 3000.00, 0.00, 7789.00, '2023-12-10 09:45:00'),

      ('SRV', 101, 14, 1000.00, 0.00, 2789.00, '2023-11-25 11:15:00'),
      ('CPV', 102, 14, 0.00, 500.00, 2289.00, '2023-12-02 16:20:00'),
      ('GV',  103, 14, 1500.00, 0.00, 3789.00, '2023-12-07 08:50:00'),

      ('BPV', 103, 13, 7000.00, 0.00, 6789.00, '2023-12-03 13:10:00'),
      ('GV', 102, 13, 0.00, 3500.00, 3289.00, '2023-12-09 12:40:00'),
      ('SRV', 101, 13, 2500.00, 0.00, 5789.00, '2023-12-12 15:00:00');`
    );
